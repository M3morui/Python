...
with open("menza.txt", "r", encoding="UTF8") as fajl:
    ...
    for sor in sorok[1:]:
        ...
        lista.append([osztály, oszletszam, honap, ar, kedvezmeny])
...
with open("befizetes.txt", "w", encoding="UTF8") as file:
    ...
    for item in lista:
        ...
        file.write(f"\nOsztály: {item[0]}, Teljes áras befizetések: {round(teljesar)},  Kedvezményes befizetések: {round(kedvezmenyes)}, Összeg: {round(teljesar+kedvezmenyes)}")
