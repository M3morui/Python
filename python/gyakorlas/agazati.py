...
# szam2 = int(input("Kérem az második számot: "))
...
evszam2 = int(input("Kérem a másik évszamot: "))

if evszam1 < evszam2:
    start = evszam1
    end = evszam2
elif evszam1 > evszam2:
    start = evszam2
    end = evszam1
...
if len(szokoevek)==0:
    ...
    print(f"Szökőévek: {'; '.join(map(str,szokoevek))}") #join: str-eket összefűzzük